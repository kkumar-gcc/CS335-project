...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    LEFT_ASSIGN = 293,             /* LEFT_ASSIGN  */
    RIGHT_ASSIGN = 294,            /* RIGHT_ASSIGN  */
    UNSIGNED_RIGHT_ASSIGN = 295,   /* UNSIGNED_RIGHT_ASSIGN  */
    OR_OP = 296,                   /* OR_OP  */
    AND_OP = 297,                  /* AND_OP  */
    NE_OP = 298,                   /* NE_OP  */
    EQ_OP = 299,                   /* EQ_OP  */
    GE_OP = 300,                   /* GE_OP  */
    LE_OP = 301,                   /* LE_OP  */
    INSTANCEOF = 302,              /* INSTANCEOF  */
    LEFT_OP = 303,                 /* LEFT_OP  */
    RIGHT_OP = 304,                /* RIGHT_OP  */
    UNSIGNED_RIGHT_OP = 305,       /* UNSIGNED_RIGHT_OP  */
    NEW = 306,                     /* NEW  */
    INC_OP = 307,                  /* INC_OP  */
    DEC_OP = 308,                  /* DEC_OP  */
    ELLIPSIS = 309,                /* ELLIPSIS  */
    PROPORTION = 310,              /* PROPORTION  */
    PTR_OP = 311                   /* PTR_OP  */
  };
